    ...
    \chapter{Prerequisites}
        ...
        \section{Transformations}
            ...
            \subsection{2D Transformations} 
                ...
                \begin{figure}[!ht]%
                    \centering
                    \subfloat[Scaled]{{\includegraphics[width=4.5cm]{scaled.png} }}%
                    \qquad
                    \subfloat[Translation]{{\includegraphics[width=4.5cm]{translated.png} }}%
                    \qquad
                    \subfloat[Rotation]{{\includegraphics[width=4.5cm]{rotated.png} }}%
